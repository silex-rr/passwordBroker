...
use PasswordBroker\Domain\Entry\Events\ModeratorWasAddedToEntryGroup;
...
class AddModeratorToEntryGroup implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        app(EntryGroupService::class)->addUserToGroupAsModerator($this->user, $this->entryGroup, $this->encrypted_aes_password, $this->master_password);
        /**
         * @var Moderator $moderator;
         */
        $moderator = $this->entryGroup->moderators()->where('user_id', $this->user->user_id->getValue())->firstOrFail();
        event(new ModeratorWasAddedToEntryGroup($moderator));
    }
